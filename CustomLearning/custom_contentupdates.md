...
为了帮助组织过渡到员工在家办公和办公的混合工作场所，我们提供了播放列表，以帮助用户运行更有效的会议、创建非独占会议环境、进行非同步协作，以及通过实时事件覆盖大量受众。 混合工作区子类别包括以下播放列表和资产。
...
Microsoft Teams 已更新以下内容。

#### <a name="manage-meetings-playlist"></a>管理会议播放列表
管理会议播放列表具有以下新资产。
- Teams 会议的提示

#### <a name="teams-on-the-go-playlist"></a>Teams 在外播放播放列表
已使用以下新资产更新了"上一场"播放列表的 Teams。
- 在离开时启动频道
- 在外创建频道
- 管理通知
...
#### <a name="walkie-talkie-tasks-and-praise"></a>Walkie Talkie，Tasks， and一
Walkie Talkie， Tasks， and Playlist playlist has been added with the following assets.
- 对讲机
- 在 Teams 中使用任务应用
- 经理任务
- 一线工作人员的任务
...
#### <a name="intro-to-excel"></a>Excel 简介
Excel 简介播放列表具有以下新资产。
- 创建下拉列表
...
在"产品"类别中，"Office 365 基础知识"子类别已更新为"Microsoft 365 基础知识"类别。 如果已添加到自定义播放列表，"Office 365 基础知识"类别中的已停用资产仍然可用。
...
- 将 PowerPoint 中的手写墨迹更改为形状、文本或数学 (新的) 
...
## <a name="april-2020-content-updates"></a>2020 年 4 月内容更新
 为了响应当前事件，2020 年 4 月内容更新提供了旨在支持组织中远程工作的学习播放列表和资源。 我们添加了一组新的远程工作播放列表，并更新了 Microsoft Teams 内容，特别是针对 Teams 会议的内容。 我们还为 Web 播放列表添加了一组新的 Office，并添加了新的 Microsoft Forms 资产。 我们还为管理员提供了远程工作资源列表。  
 
 若要了解有关如何应用内容更新以及如何管理内容更新的信息，请参阅管理 [内容更新](custom_contentupdatesmanage.md)。 下面列出了 2020 年 4 月 Microsoft 365 学习路径内容更新。 

### <a name="office-365-was-rebranded-to-microsoft-365"></a>Office 365 已重新品牌为 Microsoft 365
Office 365 已重新品牌为 Microsoft 365。 名称更改将反映在 Microsoft 365 学习路径内容中。 

### <a name="new-or-updated-playlists"></a>新的或更新的播放列表
以下播放列表已添加或更新。  

#### <a name="work-remotely-2-new-playlists11-new-assets"></a>远程工作 (2 个新播放列表/11 个新的资产) 
向学习路径添加了一个新的"远程工作"子类别，该路径具有以下播放列表和资产： 
...
- 存储你的工作文件
- 高级替代项
##### <a name="best-practices-for-collaborating-with-office-365-6-new-assets"></a>与 Office 365 协作的最佳实践 (6 个新的资产) 
- 入门
- 共享
- 共同创作者
- 在文件中聊天
...
### <a name="teams-nine-new-assetssix-updated-assets"></a>Teams (九个新资产/六个更新) 
对 Teams 内容进行了各种更新。 
#### <a name="collaborate-in-teams-and-channels-one-newone-updated-asset"></a>在团队和频道中协作 (一个新的/一个更新的资产) 
- 创建新频道并使用私人 (频道) 
- 显示或隐藏更新 (频道) 
#### <a name="start-chats-and-calls-two-newone-updated"></a>启动聊天和通话 (两个新的/一个更新) 
- 启动和固定聊天 (新) 
- 隐藏聊天、删除 (消息) 
- 在更新 (呼叫) 
#### <a name="explore-apps-and-tools-one-new"></a>浏览应用和工具 (一个新) 
- 使用应用 (新) 
#### <a name="work-with-posts-and-messages"></a>使用帖子和消息
- 向多个频道发布消息 (新) 
#### <a name="manage-meetings-three-newfour-updated-assets"></a>管理三 (/四个已更新资产的会议) 
- 加入 Teams 会议 (新) 
- 使用更新后的"立即开会" (即时) 
- 在频道中 (新) 
- 管理会议 (新) 
...
- 在 Teams 会议期间四处移动 (更新) 
#### <a name="work-with-post-and-messages-one-new"></a>将帖子和消息 (一个新) 
- 向多个频道发布消息 (新) 

### <a name="office-for-the-web"></a>Office 网页版
Office 网页应用提供了一组播放列表，用于用户想要创建、共享和协作使用 Office 网页应用场景。 这组内容对于从 Google G Suite 切换到 Microsoft 365 的组织也十分有价值。
#### <a name="get-started-five-new-assets"></a>开始 (五个新资产) 
- 入门
- 通过搜索找到它
- 创建新文档
- 返回工作
- 推荐文件
#### <a name="outlook-for-the-web"></a>Outlook 网页
- 了解 Outlook 网页 Outlook
- 创建电子邮件回复
- 组织收件箱
- 创建签名和自动答复
- 安排约会或会议
...
- 了解适用于 Web 的 PowerPoint
- 插入图片、形状等
- 动画和过渡
- 创建一个其他人的演示文稿
- 准备好呈现时
- 设计幻灯片
#### <a name="share-your-documents"></a>共享文档
- 共享文档
- 创建可共享链接
- 仅保护文档给特定人员
- 与组织外部人员共享 
...
#### <a name="forms-four-new-assets"></a>表单 (四个新的资产)  
- 创建表单 
- 共享表单 
- 查看表单的结果 
...
可以使用学习路径在学习路径网站中构建登录页面，以支持远程工作者。 或者，可以将学习路径 Web 部件添加到学习路径网站上的现有支持页面，并筛选 Web 部件以显示"远程工作"播放列表。 下面是 Microsoft 在组织中支持远程工作的一些顶级资源的列表。 
...
- Outlook mobile：管理收件箱 (八个) 
- Outlook 移动版：五个资产 (和) 
- Outlook mobile：搜索和共享 (四个) 
...
- 创建更易于访问的 Word 文档 (八个) 
- 创建更易于访问的 Excel 工作簿 (三个资产) 
- 在 PowerPoint 中创建更多辅助幻灯片 (五个) 
