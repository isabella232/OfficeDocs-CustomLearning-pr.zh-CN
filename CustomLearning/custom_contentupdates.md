...
## <a name="april-2020-content-updates"></a>2020年4月内容更新
 作为对当前事件的响应，April 2020 内容更新提供了旨在在组织中启用远程工作的学习播放列表和资源。 我们已经添加了一组新的工作远程播放列表，大大更新了 Microsoft 团队内容，尤其是对于团队会议，为 web 播放列表添加了一组新的 Office，并添加了新的 Microsoft Forms 资产。 作为更新的一部分，我们还提供了适用于管理员的远程工作资源的列表。  
...
### <a name="teams-9-new-assets6-updated-assets"></a>团队 (9 个新资产/6 个更新的资产) 
对团队内容进行了多种更新。 
#### <a name="collaborate-in-teams-and-channels-1-new1-updated-asset"></a>在团队和频道中进行协作 (1 个新的/1 个更新的资产) 
- 创建和使用专用通道 (新) 
- 显示或隐藏频道 (更新) 
#### <a name="start-chats-and-calls-2-new1-updated"></a>启动聊天和呼叫 (2 新的/1 更新的) 
- 启动和固定聊天 (新) 
- 隐藏聊天，删除邮件 (新) 
-  (更新呼叫) 
#### <a name="explore-apps-and-tools-1-new"></a>浏览应用和工具 (1 个新) 
- 使用 (新) 的应用程序
#### <a name="work-with-posts-and-messages"></a>使用帖子和邮件
- 将邮件发布到多个频道 (新) 
#### <a name="manage-meetings-3-new4-updated-assets"></a>管理会议 (3 个新的/4 个更新的资产) 
- 加入团队会议 (新) 
- 在 "立即开会" (已更新的情况创建即时会议) 
- 在频道中开会 (新) 
-  (新) 管理会议
...
-  (更新显示 PowerPoint 幻灯片) 
- 在团队会议 (更新的过程中进行移动) 
#### <a name="work-with-post-and-messages-1-new"></a>使用 post 和 messages (1 个新) 
- 将邮件发布到多个频道 (新) 
