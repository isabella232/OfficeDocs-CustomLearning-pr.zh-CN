...
title: 独立 web 部件设置
ms.date: 02/10/2019
description: Microsoft 365 学习通道手动 web 部件设置
ms.openlocfilehash: f3271dbd75ee18db7f89fdd15ebb35c1b2bf7d97
ms.sourcegitcommit: f5a7079d56598c14aef2f4b886c025a59ba89276
ms.translationtype: MT
ms.contentlocale: zh-CN
ms.lasthandoff: 10/21/2019
ms.locfileid: "34247867"
---
# <a name="stand-alone-web-part-setup"></a>独立 web 部件设置

Microsoft 365 学习通道为已经建立了专用于培训的 SharePoint Online 新式通信网站的组织提供手动独立 web 部件设置，或者只需要在中设置 "学习路径" web 部件自己的通信网站。 请注意，手动安装需要使用 Windows PowerShell 和 SharePoint Online 命令行管理程序。 手动设置 "学习路径" Web 部件的步骤如下所示：
...
若要设置 Microsoft 365 学习路径，请将 customlearning 文件上传到租户范围的应用程序目录并部署它。 有关如何将应用程序添加到应用程序目录的详细说明，请参阅[使用应用程序目录为 SharePoint Online 环境提供自定义业务应用程序](https://docs.microsoft.com/en-us/sharepoint/use-app-catalog)。
...
- **Members 组**-管理学习路径所需的 permissons，包括隐藏和显示内容以及管理自定义播放列表
- **访问者组**-查看网站内容所需的权限。 
